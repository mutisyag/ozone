      ...
      <b-row class="justify-content-center">
        <b-col md="6">
          <div class="clearfix">
            ...
            <h4 class="pt-3"><span v-translate>Houston, we have a problem!</span></h4>
            <p class="text-muted"><span v-translate>The page you are looking for is temporarily unavailable.</span></p>
          </div>
          <b-input-group>

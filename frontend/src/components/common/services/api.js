...
const getEmailTemplates = () => fetch('email-templates/')

const getEmails = (submissionId) => fetch(`submissions/${submissionId}/email/`)

const sendEmail = (submissionId, mailData) => post(`submissions/${submissionId}/email/`, mailData)

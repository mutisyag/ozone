...
const getQuestionnaireFields = ($gettext) => {
	const questionnaireFields = {
		...
		has_exports: {
			label: `2. ${$gettext('Did your country export or re-export CFCs, halons, carbon tetrachloride, methyl chloroform, HCFCs, HBFCs, bromochloromethane, or methyl bromide in the reporting year?')}`,
			type: 'radio',
			name: 'has_exports',
			selected: null,
			options: getCommonQuestionnaireOptions($gettext),
		...
		has_produced: {
			label: `3. ${$gettext('Did your country produce CFCs, halons, carbon tetrachloride, methyl chloroform, HCFCs, HBFCs, bromochloromethane, or methyl bromide in the reporting year?')}`,
			type: 'radio',
			name: 'has_produced',
			selected: null,
			options: getCommonQuestionnaireOptions($gettext),
		...
		has_destroyed: {
			label: `4. ${$gettext('Did your country destroy any ODSs in the reporting year?')}`,
			type: 'radio',
			name: 'has_destroyed',
			selected: null,
			options: getCommonQuestionnaireOptions($gettext),
		...
		has_emissions: {
			label: `6. ${$gettext('Did your country generate the substance HFC23 in the reporting year from any facility that produces (manufactures) Annex C Group I or Annex F substances?')}`,
			type: 'radio',
			name: 'has_emissions',
			selected: null,
			options: getCommonQuestionnaireOptions($gettext),

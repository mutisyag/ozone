  ...
  const form = {
    ...
    tabs: {
      ...
      has_imports: {
        ...
        titleHtml: `<b>${$gettext('Consumption (imports)')}</b> <br><small>${$gettext('Annex F substances for exempted subsectors')} <br> ${$gettext('in metric tons (not ODP or CO₂-equivalent tonnes)')}</small>`,

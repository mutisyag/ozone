...
const DataManagerLetter = () => import(/* webpackChunkName: "letter" */ '@/components/letter/DataManager')
const DataManagerHat = () => import(/* webpackChunkName: "hat" */ '@/components/hat/DataManager')

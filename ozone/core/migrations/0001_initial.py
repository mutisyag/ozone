# Generated by Django 2.0.5 on 2018-09-10 08:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ratification_type_vienna_convention', models.CharField(choices=[('Accession', 'ACCESSION'), ('Approval', 'APPROVAL'), ('Acceptance', 'ACCEPTANCE'), ('Ratification', 'RATIFICATION'), ('Succession', 'SUCCESSION'), ('Signing', 'SIGNING')], max_length=40)),
                ('signed_montreal_protocol', models.DateField(null=True)),
                ('ratification_date_montreal_protocol', models.DateField(null=True)),
                ('ratification_type_montreal_protocol', models.CharField(choices=[('Accession', 'ACCESSION'), ('Approval', 'APPROVAL'), ('Acceptance', 'ACCEPTANCE'), ('Ratification', 'RATIFICATION'), ('Succession', 'SUCCESSION'), ('Signing', 'SIGNING')], max_length=40)),
                ('ratification_date_london_amendment', models.DateField(null=True)),
                ('ratification_type_london_amendment', models.CharField(choices=[('Accession', 'ACCESSION'), ('Approval', 'APPROVAL'), ('Acceptance', 'ACCEPTANCE'), ('Ratification', 'RATIFICATION'), ('Succession', 'SUCCESSION'), ('Signing', 'SIGNING')], max_length=40)),
                ('ratification_date_copenhagen_amendment', models.DateField(null=True)),
                ('ratification_type_copenhagen_amendment', models.CharField(choices=[('Accession', 'ACCESSION'), ('Approval', 'APPROVAL'), ('Acceptance', 'ACCEPTANCE'), ('Ratification', 'RATIFICATION'), ('Succession', 'SUCCESSION'), ('Signing', 'SIGNING')], max_length=40)),
                ('ratification_date_montreal_amendment', models.DateField(null=True)),
                ('ratification_type_montreal_amendment', models.CharField(choices=[('Accession', 'ACCESSION'), ('Approval', 'APPROVAL'), ('Acceptance', 'ACCEPTANCE'), ('Ratification', 'RATIFICATION'), ('Succession', 'SUCCESSION'), ('Signing', 'SIGNING')], max_length=40)),
                ('ratification_date_beijing_amendment', models.DateField(null=True)),
                ('ratification_type_beijing_amendment', models.CharField(choices=[('Accession', 'ACCESSION'), ('Approval', 'APPROVAL'), ('Acceptance', 'ACCEPTANCE'), ('Ratification', 'RATIFICATION'), ('Succession', 'SUCCESSION'), ('Signing', 'SIGNING')], max_length=40)),
                ('remarks', models.CharField(blank=True, max_length=512)),
                ('parent_party', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='child_parties', to='core.Party')),
            ],
        ),
        migrations.CreateModel(
            name='PartyHistory',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('remark', models.CharField(blank=True, max_length=256)),
                ('annex_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='substances', to='core.Annex')),
                ('group_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='substances', to='core.Group')),
            ],
        ),
        migrations.CreateModel(
            name='Treaty',

    ...
    def get_data(self, row, party, period):
        ...
        return {
            "submission": {
                ...
                "flag_has_reported_a1": bool(overall["AI_ComplRep"]),
                "flag_has_reported_a2": bool(overall["AII_ComplRep"]),
                "flag_has_reported_b1": bool(overall["BI_ComplRep"]),
                "flag_has_reported_b2": bool(overall["BII_ComplRep"]),
                "flag_has_reported_b3": bool(overall["BIII_ComplRep"]),
                "flag_has_reported_c1": bool(overall["CI_ComplRep"]),
                "flag_has_reported_c2": bool(overall["CII_ComplRep"]),
                "flag_has_reported_c3": bool(overall["CIII_ComplRep"]),
                "flag_has_reported_e": bool(overall["EI_ComplRep"]),
                "flag_has_reported_f": bool(overall["F_ComplRep"]),

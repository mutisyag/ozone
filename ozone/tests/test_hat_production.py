...
HAT_PROD_DATA = {
    'quantity_msac_produced': 100,
    'quantity_sdac_produced': 101,
    'quantity_dcpac_produced': 102,
...
class TestHATProduction(BaseHATProductionTest):
    ...
    def test_update(self):
        ...
        data = dict(HAT_PROD_DATA)
        data["substance"] = self.substance.id
        data["quantity_msac_produced"] = 42
        ...
        self.assertEqual(hat_prod.quantity_msac_produced, 42)
    ...
    def test_clone(self):
        ...
        self.assertEqual({
            'quantity_msac_produced': new_hat.quantity_msac_produced,
            'quantity_sdac_produced': new_hat.quantity_sdac_produced,
            'quantity_dcpac_produced': new_hat.quantity_dcpac_produced,
